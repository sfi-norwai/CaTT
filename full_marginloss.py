...
def main(ssl_loader, valid_loader):
    ...
    mask_fraction = args['mask_fraction']  # For example, 10% of the elements will be masked
    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx, time_series in enumerate(tqdm(ssl_loader)):
            ...
            train_loss = contrastive_loss + mse_lambda*mse_loss
        ...
        if epoch % config.VALID_INTERVAL == 0:
            ...
            for time_series in tqdm(valid_loader):
                ...
                valid_loss = contrastive_loss + mse_lambda*mse_loss
