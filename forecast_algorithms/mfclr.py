...
from src.models.mfclr_forecastenc import *
...
class MF_CLR:
    ...
    def __init__(
        ...
        grain_split = [input_dims, input_dims]
    ...
    def encode(self, data, mask=False, encoding_window=None, causal=False, sliding_length=None, sliding_padding=0, batch_size=None):
