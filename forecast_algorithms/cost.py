...
import numpy as np
from models.timedrlmodel import TimeDRL_NET
from models.costmodel import *
from models.costencoder import *

from models.contrastive import LS_HATCL_LOSS, HATCL_LOSS
from models.layers.Embed import Patching
...
class CoST:
    ...
    def __init__(
        ...
        net = CoSTEncoder(
                ...
                length=300,
                hidden_dims=input_dims, depth=10,
            )
        ...
        self.net = torch.optim.swa_utils.AveragedModel(self._net.encoder_q)
        self.net.update_parameters(self._net.encoder_q)
    ...
    def _eval_with_pooling(self, x, mask=None, slicing=None, encoding_window=None):
        ...
        out = self.net(x.to(self.device, non_blocking=True), mask, eval=True)
